 ...
 * 项目名称：credirCardApi
 * 项目版本：V1.0
 * 包名称：com.card.api.organ.controller
 * 创建人：yuqy
 * 创建时间：2017/1/13 15:05
 * 修改人：yuqy
 * 修改时间：2017/1/13 15:05
 * 修改备注：
 */
@RestController
...
public class OrganController extends BaseController
{
     ...
     * @return
     */
    @ApiOperation(value = "组织列表", notes = "查询出信用卡组织列表")
    ...
    )
    {
        ...
        try {
            ...
            {
                //查询列表
                List<OrganBean> organs = organService.list();
                //返回列表
                returnJson.put(RETURN_RESULT,organs);
            }
        }
        //业务异常
