package com.card.api.level.controller;

import com.alibaba.fastjson.JSONObject;
import com.card.api.level.bean.LevelBean;
import com.card.api.level.service.LevelService;
 ...
 * 项目名称：credirCardApi
 * 项目版本：V1.0
 * 包名称：com.card.api.level.controller
 * 创建人：yuqy
 * 创建时间：2017/1/13 14:55
 * 修改人：yuqy
 * 修改时间：2017/1/13 14:55
 * 修改备注：
 */
@RestController
...
public class LevelController extends BaseController
{
     ...
     * @return
     */
    @ApiOperation(value = "等级列表", notes = "查询出信用卡等级列表")
    ...
    )
    {
        ...
        try {
            ...
            {
                //查询用途列表
                List<LevelBean> levels = levelService.list();
                //返回用途列表
                returnJson.put(RETURN_RESULT,levels);
            }
        }
        //业务异常
